...
def get_most_common_month(people):
    ...
    month_with_most_birthdays = None
    for month in months:
        if months[month] != 0 and month_with_most_birthdays is None:
            month_with_most_birthdays = month
        elif months[month] > months[month_with_most_birthdays]:
            month_with_most_birthdays = month
    # TODO: Modify the return statement.
    return month_with_most_birthdays
